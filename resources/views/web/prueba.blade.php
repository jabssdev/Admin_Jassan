...
<!-- Title -->
<title>JASSAN Bienes Raíces</title>
<!-- Favicon -->
						...
						<div class="home1-advnc-search home5">
							...
							<form class="home5_advanced_search_form">
								<div class="main-title ">
									<h3 class="color_principal" style="font-weight: 800;font-size: 1.6rem;line-height: 2.062rem;">¿Quieres vender, comprar o alquilar una propiedad?</h3>
					...
					<div class="row">
									...
									<div class="column-content">
										<div class="row align-items-center">
											...
											<div class="col-lg-9 col-md-12">
												<p class="text-white"><b>+9</b> años de experiencia</p>
											</div>
										</div>
									</div>
								</div>
								<div class="col-lg-4">
									...
									<div class="column-content">
										<div class="row align-items-center">
											...
											<div class="col-lg-9 col-md-12">
												<p class="text-white"><b>+457</b> propiedades vendidas</p>
											</div>
										</div>
									</div>
								</div>
								<div class="col-lg-4">
									...
									<div class="column-content">
										<div class="row align-items-center">
											...
											<div class="col-lg-9 col-md-12">
												<p class="text-white"><b>+13</b> ventas en tiempo record</p>
											</div>
										</div>
									</div>
								</div>
						...
						<div class="col-lg-6"  >
							<div class="column-content text-center">
								<h2 class="text-white">Jassan BienesRaíces Trujillo</h2>
								...
								<div class="d-flex justify-content-center">
								   ...
								   <p class="text-white" style="font-size: 1rem;line-height: 15px;">&nbsp;info&#64;jassan.pe</p>
							   </div>
				...
				<div class="col-lg-12">
					<div class="feature_property_slider">
						<div class="item">
							<div class="feat_property">
								<div class="thumb">
									<img class="img-whp" src="{{asset('web/images/en_venta/ADONDEVIVIR JASSAN.jpg')}}" alt="fp1.jpg">
								</div>
								<div class="details">
									<div class="tc_content">
										<p class="text-thm">Departamento</p>
										<h4>Mz. I. Lote 07 URB. EL VALLE II ETAPA</h4>
										<hr>
									...
									<div class="fp_footer">
										<p class="text-center price">$ 79,900.00 - S/306,600.00</p>
										<div class="row">
										  <div class="col-lg-12">
											<button type="button" class="btn btn-lg btn-transparent btn-block">Ver Propiedad</button>
										  </div>
				...
				<div class="col-lg-12">
					<div class="feature_property_slider">
						<div class="item">
							<div class="feat_property">
								<div class="thumb">
									<img class="img-whp" src="{{asset('web/images/venta_alquiler/VENTA_CASA_A_150_METROS_DE_UCV_JASSAN_MONICA.png')}}" alt="fp1.jpg">
								</div>
								<div class="details">
									<div class="tc_content">
					...
					<div class="testimonial_slider_home9">
						<div class="item">
							<div class="testimonial_post">
								...
								<div class="thumb">
									<img src="{{asset('web/images/testimonial/1.jpg')}}" alt="1.jpg">
									<h4 class="title color_principal">Augusta Silva <br><small class="text-thm">Sales Manager</small></h4>
								</div>
							</div>
						</div>
						<div class="item">
							<div class="testimonial_post">
								...
								<div class="thumb">
									<img src="{{asset('web/images/testimonial/2.jpg')}}" alt="2.jpg">
	...
	<section id="property-city" class="property-city pb30">
		<div class="container">
			<div class="row">
				...
				background-image: url('web/images/bg-principal/jassan.jpg');
				...
				<div class="col-sm-6 col-lg-6 col-xl">
					<div class="property_video">
						<div class="thumb">
							<img class="pro_img img-fluid w100" src="{{asset('web/images/bg-principal/jassan.jpg')}}" alt="7.jpg">
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-8 offset-lg-3">
					<div class="main-title text-center">
						<h2 class="indhead text_solga">Soy Jassan Bienes Raíces Trujillo</h2>
			...
			<div class="row">
				<div class="col-lg-8 col-xl-7">
					<div class="about_content ">
						<p class="text-justify text_solga">Sé lo importante que es para ti la compra de tu nueva casa o departamento y que necesitas de un profesional que te brinde el apoyo para calificar a un crédito hipotecario con la menor tasa y cuota mensual, que te brinde las mejores alternativas de viviendas en el mercado inmobiliario de Trujillo y un completo asesoramiento del estado legal de la propiedad, documentos del inmueble, gastos y pagos de impuestos para realizar la compra de tu vivienda.</p>
						<p class="text-justify text_solga">Me he especializado en Procesos Inmobiliarios, para brindarte una atención de calidad, darte una Asesoría Inmobiliaria Integral que te ayude a comprar tu vivienda de manera segura y exitosa.</p>
						<p class="text-justify text_solga">Soy Jassan, Ingeniero especialista en Procesos Inmobiliarios, el mejor agente inmobiliario exitoso de la ciudad de Trujillo, con más de 07 años de experiencia ayudando a más de 400 familias.</p>
						<p class="text-justify text_solga">Me puedes contactar al email jassan.christopher&#64;departamentosenventaentrujillo.com o llamarme al +51-948950090.</p>	
						<p class="text-justify text_solga">Será un placer atenderte.</p>
						 
					</div>
				</div>
				<div class="col-lg-4 col-xl-5">
					<div class="about_thumb">
						<img class="img-fluid w100" src="{{asset('web/images/bg-principal/jassan.jpg')}}" alt="1.jpg">
	...
	<section class="footer_one">
		<div class="container">
			<div class="text-center">
				...
				<p class="footer_text_color ">JASSAN, el Ing. Jassan Christopher Guevara, es el Mejor Agente Inmobiliario Exitoso de la Ciudad de Trujillo de Perú con Registro Nº PN-6274 del MVCS, Especialista en Procesos Inmobiliarios, Venta de Inmuebles y Marketing Digital.</p>
