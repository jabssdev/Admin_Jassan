(function($) {
    ...
    /* team_slider-custom */
    if ($('.team_slider_custom').length) {
        $('.team_slider_custom').owlCarousel({
    ...
    /* wsp */
    document.getElementById('example_3').addEventListener('click', () =>{
        window.open("https://api.whatsapp.com/send?phone=51948950090", "_blank");
    })
    
     /* asoria */
     var btnaser =	document.querySelectorAll('.viewasesoria');
	var bloque = document.getElementById('form_asesoria');
	var btclose = document.getElementById('closeas');
